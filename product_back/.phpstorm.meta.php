    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'deto.api' => \Deto\Generator\Commands\API\APIGeneratorCommand::class,
            'deto.api.controller' => \Deto\Generator\Commands\API\APIControllerGeneratorCommand::class,
            'deto.api.requests' => \Deto\Generator\Commands\API\APIRequestsGeneratorCommand::class,
            'deto.api.tests' => \Deto\Generator\Commands\API\TestsGeneratorCommand::class,
            'deto.api_scaffold' => \Deto\Generator\Commands\APIScaffoldGeneratorCommand::class,
            'deto.migration' => \Deto\Generator\Commands\Common\MigrationGeneratorCommand::class,
            'deto.model' => \Deto\Generator\Commands\Common\ModelGeneratorCommand::class,
            'deto.publish' => \Deto\Generator\Commands\Publish\GeneratorPublishCommand::class,
            'deto.publish.layout' => \Deto\Generator\Commands\Publish\LayoutPublishCommand::class,
            'deto.publish.templates' => \Deto\Generator\Commands\Publish\PublishTemplateCommand::class,
            'deto.publish.user' => \Deto\Generator\Commands\Publish\PublishUserCommand::class,
            'deto.repository' => \Deto\Generator\Commands\Common\RepositoryGeneratorCommand::class,
            'deto.rollback' => \Deto\Generator\Commands\RollbackGeneratorCommand::class,
            'deto.scaffold' => \Deto\Generator\Commands\Scaffold\ScaffoldGeneratorCommand::class,
            'deto.scaffold.controller' => \Deto\Generator\Commands\Scaffold\ControllerGeneratorCommand::class,
            'deto.scaffold.requests' => \Deto\Generator\Commands\Scaffold\RequestsGeneratorCommand::class,
            'deto.scaffold.views' => \Deto\Generator\Commands\Scaffold\ViewsGeneratorCommand::class,
