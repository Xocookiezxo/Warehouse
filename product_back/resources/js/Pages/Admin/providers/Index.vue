  ...
  <Layout :title="title">
    <div>
      ...
      <div class="bg-white rounded shadow">
        ...
        <AdminTable :headers="headers" :datas="datas" url="/admin/providers" @order-by="(v) => orderBy(form, v)">
          <template #filter>
...
const title = 'Providers жагсаалт'

const headers = [
  { key: 'name', name: 'Нэр', order: 'name' },
  { key: 'contact', name: 'Холбоо барих', order: 'contact' },
  { key: 'address', name: 'Хаяг', order: 'address' },
