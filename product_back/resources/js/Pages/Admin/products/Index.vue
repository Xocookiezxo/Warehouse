  ...
  <Layout :title="title">
    <div>
      ...
      <div class="bg-white rounded shadow">
        ...
        <AdminTable :headers="headers" :datas="datas" url="/admin/products" @order-by="(v) => orderBy(form, v)">
          <template #filter>
...
const title = 'Products жагсаалт'

const headers = [
  { key: 'name', name: 'Нэр', order: 'name' },
  { key: 'provider.name', name: 'Нийлүүлэгч', order: 'provider_id', url:'/admin/providers' },
  { key: 'barcode', name: 'Баркод', order: 'barcode' },
  { key: 'price', name: 'Үнэ', order: 'price' },
  { key: 'product_category.name', name: 'Бүтгээгдэхүүны төрөл', order: 'product_category_id', url:'/admin/product_categories' },
